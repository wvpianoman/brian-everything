...
install_fedora_packages() {
    ...
    sleep 3
        ...
        sudo dnf install -y blender boomaga digfikam flameshot gimp gimp-help gimp-data-extras inkscape kdepim kdepim-addons krita neochat rhythmbox scribus scribus-doc scribus-template shotwell simplescreenrecorder syncthing transmission transmission-{remote-gtk,gtk,qt} uget vlc yakuake
        echo "Package installation completed."
    sleep 3
