# brian-everything
 ...
 This is my personal installation/maintenance scripts for **CachyOS**(*Arch*), **MXLinux**(*Debian*), **Solus**, openSUSE **Tumbleweed** and **Ultrmarine**(*Fedora*).  I also have a ***NixOS*** repo on github, but I do not use Nix any longer.
